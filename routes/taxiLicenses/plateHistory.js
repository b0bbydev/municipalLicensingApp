...
const TaxiPlateHistory = require("../../models/taxiLicenses/taxiPlateHistory");
// helpers.
...
/* GET /taxiLicenses/plateHistory/:id */
router.get(
  "/:id",
  body("filterCategory")
    .matches(/^[^'";=_()*&%$#!<>\/\^\\]*$/)
  ...
  async (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      return res.render("taxiLicenses/plateHistory", {
        title: "BWG | Plate History",
        message: "Page Error!",
      ...
      if (!req.query.filterMonth && !req.query.filterYear) {
        TaxiPlateHistory.findAndCountAll({
          where: {
