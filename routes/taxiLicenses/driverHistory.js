...
const TaxiDriverHistory = require("../../models/taxiLicenses/taxiDriverHistory");
// helpers.
...
/* GET /taxiLicenses/driverHistory/:id */
router.get(
  "/:id",
  body("filterCategory")
    .matches(/^[^'";=_()*&%$#!<>\/\^\\]*$/)
  ...
  async (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      return res.render("taxiLicenses/driverHistory", {
        title: "BWG | Driver History",
        message: "Page Error!",
      ...
      if (!req.query.filterMonth && !req.query.filterYear) {
        TaxiDriverHistory.findAndCountAll({
          where: {
